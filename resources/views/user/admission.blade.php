    ...
    <div class="row">
      ...
      <div class="col-md-8 animate-box">
        ...
        <form action="{{ route('admission.store') }}" method="post" class="form">
            ...
            <div class="row form-group">
              <div class="col-md-2 pull-left">
                <div class="form-group">
                  <label style="margin-top:-10px;" for="damme"> Mme <input type="radio" class="" name="kind" value="0" id="damme" ></label>
                </div>
              </div>
              <div class="col-md-2 pull-left">
                <div class="form-group">
                  <label style="margin-top:-10px;" for="demoisel"> Mrs  <input type="radio" class="" name="kind" value="1"  id="demoisel" ></label>
                </div>
              </div>
              <div class="col-md-2 pull-left">
                  <div class="form-group">
                    <label style="margin-top:-10px;" for="monsier"> Mr   <input type="radio" class="" name="kind" value="2"  id="monsier" ></label>
                  </div>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
              <label for="fname" class="label_lname">Prénom</label>
          ...
          <div class="col-md-12 button">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <label for="informatic">Avez-vous des notions en TIC</label>
              ...
              <div class="col-md-4">
                <label for="computer">Disposer vous d'un ordinateur</label>
                <div class="form-group radio">
                  <div class="form-group">
